function Camera({nome, numero}) {

  return (
    <>
            <button class="group relative overflow-hidden rounded-lg border bg-card text-left transition-all hover:border-red-100 border-gray-700 ring-2 ring-gray-700 animate-pulse-alert">
                <div class="relative aspect-video w-full overflow-hidden bg-[radial-gradient(circle_at_30%_20%,oklch(0.32_0.04_200)_0%,oklch(0.18_0.015_240)_60%)]">
                    ...
                    <div class="absolute left-1/2 top-1/2 h-24 w-24 -translate-x-1/2 -translate-y-1/2 rounded-full border border-red-100"></div>
                    ...
                    <div class="absolute inset-x-0 top-0 flex items-center justify-between bg-gradient-to-b from-background/80 to-transparent px-3 py-2">
                        <div class="flex items-center gap-2">
                            ...
                            <span class="text-xs font-medium text-foreground/90">Câmera {numero}</span>
                        </div>
                        <div class="flex items-center gap-1.5 rounded-md bg-gray-700 px-1.5 py-0.5 text-[10px] font-mono text-muted-foreground backdrop-blur">
                    ...
                    <div class="pointer-events-none absolute inset-0 border-2 border-gray-700"></div>
